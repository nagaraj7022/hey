...
export default function Addbook({handleRefresh}) {
    ...
    const { Title, Author, Genre, Discription, Price } = formData;
    ...
    function handleAddBook(e) {
        ...
        fetch(`https://brainy-petticoat-wasp.cyclic.cloud/api/book/add`, {
            method: "POST",
            headers: {
        ...
        <div className='addbook_container'>
            {
                isLoading ? <h1>Loading...</h1> :
                    <form onSubmit={handleAddBook}>
                        ...
                        <textarea name="Discription" value={Discription} onChange={handleChange} placeholder='Discription' required ></textarea>
